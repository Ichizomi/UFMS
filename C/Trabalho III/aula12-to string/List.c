...
*************************************************************************/
void addAtTail (List *s, char* word, char* meaning)
{
	...
	int n1 = strlen (word);
	int n2 = strlen (meaning);
	newNode->word = (char *) malloc(n1+1);
	newNode->wordMeaning = (char*) malloc(n2+1);

	strcpy (newNode->word, word);
	strcpy (newNode->wordMeaning, meaning);	
